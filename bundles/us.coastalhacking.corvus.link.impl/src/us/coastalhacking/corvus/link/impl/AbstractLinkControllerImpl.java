...
import us.coastalhacking.corvus.link.model.Container;
import us.coastalhacking.corvus.link.model.LinkMarker;
import us.coastalhacking.corvus.link.model.LinksFactory;
import us.coastalhacking.corvus.link.model.Marker;
import us.coastalhacking.corvus.link.model.Resource;
import us.coastalhacking.corvus.link.model.WorkspaceRoot;
...
public abstract class AbstractLinkControllerImpl implements LinkController {
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#addLink(org.eclipse.core.resources.IMarker)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#continueLink(org.eclipse.core.resources.IMarker)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#changedLink(org.eclipse.core.resources.IMarker)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#endLink()
	 */
	@Override
	public void endLink() {
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#removeLink(org.eclipse.core.resources.IMarker)
	 */
	@Override
	public void removeLink(IMarker subject) {
		...
		synchronized (lock) {
			...
			us.coastalhacking.corvus.link.model.Resource resource = null;
			for (us.coastalhacking.corvus.link.model.Resource r: container.getResources()) {
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#getMarkers(org.eclipse.core.resources.IMarker, boolean)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#getMarkerAtSelection(org.eclipse.core.resources.IResource, int, int)
	 *
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see us.coastalhacking.corvus.link.api.LinkController#hasMarkers(org.eclipse.core.resources.IMarker, us.coastalhacking.corvus.link.api.Link.Direction)
	 */
	@Override
	...
	LinkMarker getOrCreateLinkMarkerNoLock(IMarker subject, boolean create) {
		...
		for (us.coastalhacking.corvus.link.model.Resource r: resources) {
			if (r.getPortableProjectRelativePath() != null &&
					r.getPortableProjectRelativePath().equals(resourcePath)) {
				resource = r;
			}
