/**
 */
package prototype.link.model.util;
...
public class LinksAdapterFactory extends AdapterFactoryImpl {
	...
	protected LinksSwitch<Adapter> modelSwitch =
		new LinksSwitch<Adapter>() {
			...
			@Override
			public Adapter caseLinkMarker(LinkMarker object) {
				return createLinkMarkerAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link prototype.link.model.WorkspaceRoot <em>Workspace Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link prototype.link.model.Container <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link prototype.link.model.Resource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link prototype.link.model.Marker <em>Marker</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link prototype.link.model.LinkMarker <em>Link Marker</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createLinkMarkerAdapter() {
		return null;
	}
